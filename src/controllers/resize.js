...
export default function luckysheetsizeauto(isRefreshCanvas=true) {
    ...
    if (luckysheetConfigsetting.custombarBar != '') {
        Store.custombarHeight = document.querySelector('.luckysheet-custom-element-header').offsetHeight;
    }
    ...
    $("#" + Store.container).find(".luckysheet-grid-container").css("top", Store.toolbarHeight + Store.infobarHeight + Store.calculatebarHeight + Store.custombarHeight);
...
export function changeSheetContainerSize(gridW, gridH){
    ...
    Store.cellmainHeight = gridH - (Store.infobarHeight + Store.toolbarHeight + Store.custombarHeight + Store.calculatebarHeight + Store.columnHeaderHeight + Store.sheetBarHeight + Store.statisticBarHeight);
