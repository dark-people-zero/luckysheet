...
const imageCtrl = {
    ...
    getImgItemParam(imgItem){
        ...
        if(isFixedPos){
            ...
            const operateAreaHeight = Store.infobarHeight + Store.toolbarHeight + Store.custombarHeight + Store.calculatebarHeight + Store.columnHeaderHeight;
    ...
    addImgItem: function(img) {
        ...
        imgItem.fixedTop = img.top - scrollTop + Store.infobarHeight + Store.toolbarHeight + Store.custombarHeight + Store.calculatebarHeight + Store.columnHeaderHeight;
    ...
    pasteImgItem: function() {
        ...
        img.fixedTop = img.default.top - scrollTop + Store.infobarHeight + Store.toolbarHeight + Store.custombarHeight + Store.calculatebarHeight + Store.columnHeaderHeight;
